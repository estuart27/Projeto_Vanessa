...
class Pedido(models.Model):
    ...
    frete = models.FloatField(default=0)  # Campo para armazenar o valor do frete
...
class ItemPedido(models.Model):
    ...
    cor = models.CharField(max_length=50, blank=True, null=True)  # Nova linha
    cor_id = models.PositiveIntegerField(blank=True, null=True)   # Nova linha
